...
% 
% If the option -t is given as the last argument, the
% first part of the output is printed as a table (CSV).
%
...
try %#ok
    ...
    if isempty(varargin) || strcmp(varargin{1},'-q'),
        ...
        fprintf('\n');
        fprintf('If the option -t is given as the last argument, the\n');
        fprintf('first part of the output is printed as a table (CSV).\n');
        fprintf('\n');
